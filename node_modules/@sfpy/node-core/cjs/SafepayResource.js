...
exports.SafepayResource = void 0;
const utils_js_1 = require("./utils.js");
const SafepayMethod_js_1 = require("./SafepayMethod.js");
// Provide extension mechanism for Safepay Resource Sub-Classes
SafepayResource.extend = utils_js_1.protoExtend;
// Expose method-creator
SafepayResource.method = SafepayMethod_js_1.safepayMethod;
/**
 * Encapsulates request logic for a Safepay Resource
 */
function SafepayResource(safepay) {
...
exports.SafepayResource = SafepayResource;
SafepayResource.prototype = {
    ...
    _getRequestOpts(requestArgs, spec) {
        ...
        const urlData = urlParams.reduce((urlData, param) => {
            ...
            if (typeof arg !== "string") {
                throw new Error(`Safepay: Argument "${param}" must be a string, but got: ${arg} (on API request to \`${requestMethod} ${path}\`)`);
            }
            urlData[param] = arg;
            return urlData;
        }, {});
        ...
        if (args.filter((x) => x != null).length) {
            throw new Error(`Safepay: Unknown arguments (${args}) (on API request to ${requestMethod} \`${path}\`)`);
        }
    ...
    _makeRequest(requestArgs, spec) {
        return new Promise((resolve, reject) => {
            ...
            return this._safepay._requestSender._request(opts.requestMethod, opts.host, opts.requestPath, opts.bodyData, opts.queryData, opts.auth, { headers, settings }, requestCallback);
        });
    },
};
